...
(function ($) {
  ...
  $container.append(
    '<h5>Personalizar Panel Admin</h5><hr class="mb-2"/>'
  )
  ...
  var $header_fixed_container = $('<div />', { class: 'mb-1' }).append($header_fixed_checkbox).append('<span>Fijar</span>')
  ...
  var $dropdown_legacy_offset_container = $('<div />', { class: 'mb-1' }).append($dropdown_legacy_offset_checkbox).append('<span>Dropdown Plegable</span>')
  ...
  $container.append('<h6>Opciones de Sidebar</h6>')
  ...
  var $sidebar_fixed_container = $('<div />', { class: 'mb-1' }).append($sidebar_fixed_checkbox).append('<span>Fijar</span>')
  ...
  var $flat_sidebar_container = $('<div />', { class: 'mb-1' }).append($flat_sidebar_checkbox).append('<span>Nav Estilo Plano</span>')
  ...
  var $legacy_sidebar_container = $('<div />', { class: 'mb-1' }).append($legacy_sidebar_checkbox).append('<span>Nav EStilo Heredado</span>')
  ...
  var $compact_sidebar_container = $('<div />', { class: 'mb-1' }).append($compact_sidebar_checkbox).append('<span>Nav Compacto</span>')
  ...
  var $child_indent_sidebar_container = $('<div />', { class: 'mb-1' }).append($child_indent_sidebar_checkbox).append('<span>Nav Identacion de Hijos</span>')
  ...
  var $child_hide_sidebar_container = $('<div />', { class: 'mb-1' }).append($child_hide_sidebar_checkbox).append('<span>Nav Ocultar Hijos al Colapsar</span>')
  ...
  var $footer_fixed_container = $('<div />', { class: 'mb-4' }).append($footer_fixed_checkbox).append('<span>Fijar</span>')
  ...
  var $text_sm_footer_container = $('<div />', { class: 'mb-4' }).append($text_sm_footer_checkbox).append('<span>Pie de Pagina</span>')
  ...
  $container.append('<h6>Variante Oscura  de SideBar</h6>')
  ...
  $container.append('<h6>Variante Clara de SideBar</h6>')
